<div class="nav-content d-flex">
    ...
    <div class="user-container d-flex">
        <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="profile" alt="profile" src="https://team.picruit.com/public/{{$admin?$admin->profile:"/img/profile/profile-3.webp"}}" />
            <div class="name">@if($admin->usertype==1)Employeer
            @elseif($admin->usertype==2)Manager
            @else Other
            @endif</div>
        </a>
