...
@endphp
                            <div class="list-group lg-alt user-list">
                                ...
                                <a class="list-group-item media" href="javascript:chatwith({{$userz['id']}})" id="{{$userz['id']}}">
                                    ...
                                    <div class="pull-left">
                                        ...
                                        @endphp
                                        @if($useri)
                                        <img src="https://picruit.com/public/{{$useri?$useri['image']:""}}" alt="" class="img-avatar" />
                                        @else
                                        <img src="https://picruit.com/public/images/profile.webp" alt="" class="img-avatar"/>
                                        @endif
                        ...
                        <div class="ms-body">
                            <div class="action-header clearfix" style="padding-bottom: 35px;">
                             ...
                             <div class="sendchat" id="chatsend">
                                 Send message
                    </div>
 ...
 function chatwith(i)
    {
     ...
     $.ajax({
                                ...
                                success: function(result)
                                {
                                 ...
                                 {
                                     for(i=0;i<=len;i++){
                                         chatrec(result[i].incoming_user_id);
                                 $("#chatsend").append(' <div class="message-feed media"><div class="pull-left"><img src="https://picruit.com/public/'+result[i]["incoming_user_id_img"]+'" alt="" class="img-avatar"></div><div class="media-body"><div class="mf-content">'+result[i]["message"]+'</div><small class="mf-date"><i class="fa fa-clock-o"></i> '+result[i]["created_at"]+'</small></div></div>');
                                    
                                 
                                        var mdiv=document.getElementById("chatsend");  
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                 ...
                                 console.log("comming msg",result);
                                 var len=result.length;
                                 var i;
                                 if(len!=0)
                                 {
                                     for(i=0;i<len;i++){
                                 $("#chatplay").append(' <div class="message-feed media"><div class="pull-left"><img src="https://picruit.com/public/'+result[i]["incoming_user_id_img"]+'" alt="" class="img-avatar"></div><div class="media-body"><div class="mf-content">'+result[i]["message"]+'</div><small class="mf-date"><i class="fa fa-clock-o"></i> '+result[i]["created_at"]+'</small></div></div>');
