        ...
        <!-- Title and Top Buttons End -->
                     ...
                     <div>
                        ...
                        <form action="{{route('edit-user')}}" method="POST">
                            @csrf
                            <input type="hidden" class="form-control" value="{{$Userprofile->user_id}}" name="user_id">
                        <div class="mb-3 row">
                        <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Name</label>
                        <div class="col-sm-8 col-md-9 col-lg-10">  
                        <input type="text" class="form-control" value="{{$Userprofile->f_name?$Userprofile->f_name:"Empty"}}" name="f_name">
                        </div>
                        </div>
                         <div class="mb-3 row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Last Name</label>
                            <div class="col-sm-8 col-md-9 col-lg-10">
                            <input type="text" name="l_name" class="form-control" value="{{$Userprofile->l_name?$Userprofile->l_name:"Empty"}}">
                            </div>
                            </div>
                        ...
                        <div class="col-sm-8 col-md-9 col-lg-10">
                        <input type="text" class="form-control" name="aera" value="{{$Userprofile->area?$Userprofile->area:"Empty"}}">
                        </div>
                        </div>
