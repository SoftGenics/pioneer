        ...
        <!-- Title and Top Buttons End -->
                     ...
                     <div>
                        ...
                        <form action="{{route('edit-user')}}" method="POST">
                            @csrf
                            <input type="hidden" class="form-control" value="{{$Userprofile->id?$Userprofile->user_id:"Empty"}}" name="user_id">
                        <div class="mb-3 row">
                        ...
                        <div class="col-sm-8 col-md-9 col-lg-10">
                        <input type="text" class="form-control" name="city" value="{{$Userprofile->city?$Userprofile->city:"Empty"}}">
                        </div>
                        </div>
