                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="" action="{{route('New-post-job')}}" method="post">
                            @csrf
                          <div class="form-floating mb-3">
                              <input type="hidden" name="user_id" value="1" />
                            <input type="text" class="form-control border border-info" placeholder="" name="title">
                          ...
                          <div class="form-floating mb-3 ">
                            ...
                            <input type="date" name="date" class="form-control  border border-info" id="date">
                          ...
                          <div class="form-floating mb-3">
                            <input type="number" class="form-control border border-info" placeholder="" name="salary">
                          ...
                          <div class="form-floating mb-3">
                              <input type="time" class="form-control  border border-info" id="stime" name="start_time">
                          ...
                          <div class="form-floating mb-3">
                              ...
                              <input type="time" class="form-control border border-info" id="etime" name="end_time">
                          ...
                          <div class="form-floating mb-3">
                            <textarea class="form-control border border-info" name="job_detail" >
                          ...
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info" placeholder="" name="location">
