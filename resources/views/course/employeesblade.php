...
<tr class="myList mycity">
  ...
  <td>{{$item->name?$item->name:"Name is Empty"}}</td>
  <td>{{$item->name?$item->email:"Email is Empty"}}</td>
  <td>{{$item->name?$item->country:"country is Empty"}}</td>
  <td>{{$item->city?$item->city:"City is empty"}}</td>
  <td>{{$item->mode?$profile->mode:"mode is empty"}}</td>
