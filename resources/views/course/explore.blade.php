    ...
    <div class="container">
        ...
        <div class="card mb-5">
            <div class="card-body">
               ...
               <div style="color:red">{Note:image size should be less then 3MB}</div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="mt-n1">
                <button class="btn btn-icon btn-icon-end btn-background pe-0 pt-0" type="button" id="viewalldata">
                    View All
                    <i data-acorn-icon="chevron-right"></i>
                </button>
                 <button class="btn btn-icon btn-icon-end btn-background pe-0 pt-0" type="button" id="lessdata">
                    View All
                    <i data-acorn-icon="chevron-right"></i>
                </button>
            </div>
        </div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-5" id="fewdata">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-5" id="alldata">
